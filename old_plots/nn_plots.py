...
###### KNN SFS #######
file_SFS = open('nn_SFS.json', 'r')
SFS = json.load(file_SFS)



sfs_accuracy = SFS['all_accs']
sfs_frequencies = SFS["nn_freqs"]

# Read file
file_SBS = open('nn_SBS.json', 'r')
...
plots.create_table('nn_sfs_table.csv', sfs_frequencies)
plots.create_table('nn_sbs_table.csv', sbs_frequencies)
