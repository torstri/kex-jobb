...
Feature 151 is called "Extent" and measure how many of the pixels in an image are inside the lesion. % inside?
Feature 160 is a color feature... % Fortsätt
...
% There were XX features with zero occurences.
...
From the results, it becomes apparent that the classifier used a lot of features compared to the other classifiers. The most prominent feature was 80, which is a SIFT feature and was present in the optimal feature set in all tests.
