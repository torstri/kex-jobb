...
\section{Determining most important features} % Maybe move this section one step up?

Below are a table showing the features that were included in the optimal set the most. The features are sorted in descending order based on how many times they were included in the optimal feature set.

% TODO: Insert the big_data_new table here, showing the most important features for all classifiers using SFS and SBE

% Dubbelkolla denna paragraf så allt stämmer.
...
% TODO: Insert ABCD vs SIFT table here
...
% TODO: Insert the two tables here, showing the most important features for KNN using SFS and SBE

From the results we can see that the SFS preffered more features than the SBE counter part. Furthermore, there is very little overlap between the preffered features when comparing the two methods. The only feature that has a probaility of 80 percent or more is number 151, which corresponds to an extent feature from the ABCD method.



\subsection{Neural Network}

% TODO: Insert the two tables here, showing the most important features for NN using SFS and SBE



\subsection{Random Forest}

% TODO: Insert the two tables here, showing the most important features for RF using SFS and SBE

\subsection{Support Vector Machine}

% TODO: Insert the two tables here, showing the most important features for SVM using SFS and SBE
